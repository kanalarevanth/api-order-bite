...
import { getAdminRecipes, getAdminRecipe, addAdminRecipe, validateAddRecipe, validateUpdateRecipe, updateAdminRecipe, deleteAdminRecipe } from '../../../controllers/admin/recipes';
...
adminRecipes.delete('/:recipeId', (req, res) => res.handle(deleteAdminRecipe));
